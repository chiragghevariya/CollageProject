...
@section('content')
    ...
    @if($profile->count() > 0)
        ...
        <div class="row" style="  margin: auto;width:90%;margin-top: 2em">
            ...
            <div class="col-md-3" style="margin-top: 5em ">
                ...
                <a class="btn btn-success" href="{{route('facultyprofile.edit',['id'=>$profile->id])}}">Update</a>
                <div style="margin-top: 1em">

                    <form method="post" action="{{Route('facultyprofile.destroy',['id'=>$profile->id])}}">
                        {{csrf_field()}}
                        {{method_field('delete')}}
    ...
    @else
        ...
        <form method="post" action="{{route('facultyprofile.store')}}" enctype="multipart/form-data">
